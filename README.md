...
This is fully functioning site that is capable of doing the following using a PostgreSQL database:
...
The Frontend of this app if built using Node. if you want to run the app download and install the [Node.js](https://nodejs.org/en/download/).
